...
public class SpecialOfferDirectory {
	...
	static {
		offers.add(new RuleDTO(RuleIDConstant.BUNDLE_PRICE, "02/26/2018", "itemName = A|quantity = 3|bundlePrice =130"));
		offers.add(new RuleDTO(RuleIDConstant.BUNDLE_PRICE, "02/26/2018", "itemName = B|quantity = 2|bundlePrice =45"));
	}
}
